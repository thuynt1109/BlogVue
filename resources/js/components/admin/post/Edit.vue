                        ...
                        <form role="form" enctype="multipart/form-data" @submit.prevent="updatePost()">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="postId">Chỉnh sửa tin tức </label>
                                    <input type="text" class="form-control" id="postId" placeholder="Thêm tin tức mới" v-model="form.title" name="title" :class="{ 'is-invalid': form.errors.has('title') }">
